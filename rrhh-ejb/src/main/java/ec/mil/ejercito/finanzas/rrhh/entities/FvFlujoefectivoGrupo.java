...
/**
 * The persistent class for the FV_FLUJOEFECTIVO_GRUPO database table.
 * 
 */
@Entity
@Table(name="FV_FLUJOEFECTIVO_GRUPO")
@NamedQuery(name="FvFlujoefectivoGrupo.findAll", query="SELECT f FROM FvFlujoefectivoGrupo f")
public class FvFlujoefectivoGrupo implements Serializable {
