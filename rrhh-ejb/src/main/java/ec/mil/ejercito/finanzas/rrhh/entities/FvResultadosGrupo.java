...
/**
 * The persistent class for the FV_RESULTADOS_GRUPO database table.
 * 
 */
@Entity
@Table(name="FV_RESULTADOS_GRUPO")
@NamedQuery(name="FvResultadosGrupo.findAll", query="SELECT f FROM FvResultadosGrupo f")
public class FvResultadosGrupo implements Serializable {
